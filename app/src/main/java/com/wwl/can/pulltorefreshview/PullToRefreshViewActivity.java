...
import com.wwl.can.MainActivity;
import com.wwl.can.R;
import com.wwl.can.pulltorefreshview.PullRefreshView.IOnfootRefreshListener;

import java.util.ArrayList;
import java.util.List;

public class PullToRefreshViewActivity extends AppCompatActivity implements PullRefreshView.IOnHeaderRefreshListener, IOnfootRefreshListener {
    ...
    public void onHeaderRefresh(final PullRefreshView view) {
        new Handler().postDelayed(new Runnable() {
            @Override
            public void run() {
                Toast.makeText(PullToRefreshViewActivity.this, "刷新完成", Toast.LENGTH_SHORT).show();
